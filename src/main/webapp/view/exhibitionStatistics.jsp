...
<table class="statistic">
    ...
    <c:forEach var="exhibitionStats" items="${exhibitionsStats}">
        <tr>
            <td>${exhibitionStats.key.theme}</td>
            <td>From ${exhibitionStats.key.startDate} To ${exhibitionStats.key.endDate}</td>
            <td>
               <c:forEach var="hall" items="${exhibitionStats.key.getHalls()}">
                    ${hall.name} <br/>
                </c:forEach> 
            </td>
            <td>${exhibitionStats.key.price}</td>
            <td>${exhibitionStats.value}</td>
            <td><a href="../home?command=getDetailedStats&exhibitionID=${exhibitionStats.key.id}&exhibitionTheme=${exhibitionStats.key.theme}" class="active"><fmt:message key='exhibitionStatistics.table.button.getDetailedStatistics'/></a></td>
        </tr>
    </c:forEach>
</table>
